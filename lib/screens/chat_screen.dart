...
class ChatScreen extends StatefulWidget {
  const ChatScreen({super.key, required this.number, required this.docId});
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: StreamBuilder<DocumentSnapshot>(
          stream: FirebaseFirestore.instance.collection('chats').doc(widget.docId).snapshots(),
          builder: (context, snapshot) {
            ...
            if (!snapshot.hasData || snapshot.data!.data() == null) {
              return Column(
                ...
                children: [
                  Text('Start a conversation with ${widget.number}'),
              ...
              actions: [
                TextButton(
                  onPressed: (){
                    ...
                    services.deleteMessage(index, snapshot, docId, "chats");
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                ...
                services.sendMessage(widget.docId, _messageController.text.trim(), "chats");
